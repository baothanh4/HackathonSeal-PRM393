...
import com.example.hackthonseal.models.dto.response.TeamMemberResponse;
...
import com.example.hackthonseal.repo.TeamRepository;
import com.example.hackthonseal.repo.UserProfileRepository;
import com.example.hackthonseal.services.Interface.TeamService;
...
public class TeamServiceImpl implements TeamService {
    ...
    private TeamResponse mapToTeamResponse(Team team) {
        ...
        List<TeamMemberResponse> members = registrations.stream().map(reg -> {
            boolean isGuest = reg.getUser() == null;
            String studentCode = null;
            String university = "FPT University";

            if (isGuest) {
                studentCode = reg.getGuestStudentCode();
                university = reg.getGuestUniversity();
            } else {
            ...
            return TeamMemberResponse.builder()
                    ...
                    .userId(isGuest ? null : reg.getUser().getId())
                    .fullName(isGuest ? reg.getGuestName() : reg.getUser().getFullName())
                    .email(isGuest ? reg.getGuestEmail() : reg.getUser().getEmail())
